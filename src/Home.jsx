		...
		<div className="row g-5">
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-aspect-ratio" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
				...
				<h5 className="mt-3">Array Rendering</h5>
				    <button onClick={() => navigate("/arrarendering")}>
						ArrayRender
					</button>
			</div>
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-emoji-wink" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
				...
				<h5 className="mt-3">Object</h5>
				 <button onClick={() => navigate("/objectdering")}>
						ObjectRender
					</button>
			</div>
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-layout-text-window-reverse" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
			...
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-clipboard-check" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
					<path d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z" fillRule="evenodd"></path>
				...
				<h5 className="mt-3">Prop</h5>
				 <button onClick={() => navigate("/propdrill")}>
						PropDrilling
					</button>
			</div>
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-speedometer2" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
					<path d="M8 4a.5.5 0 0 1 .5.5V6a.5.5 0 0 1-1 0V4.5A.5.5 0 0 1 8 4zM3.732 5.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707zM2 10a.5.5 0 0 1 .5-.5h1.586a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 10zm9.5 0a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H12a.5.5 0 0 1-.5-.5zm.754-4.246a.389.389 0 0 0-.527-.02L7.547 9.31a.91.91 0 1 0 1.302 1.258l3.434-4.297a.389.389 0 0 0-.029-.518z"></path>
					<path d="M0 10a8 8 0 1 1 15.547 2.661c-.442 1.253-1.845 1.602-2.932 1.25C11.309 13.488 9.475 13 8 13c-1.474 0-3.31.488-4.615.911-1.087.352-2.49.003-2.932-1.25A7.988 7.988 0 0 1 0 10zm8-7a7 7 0 0 0-6.603 9.329c.203.575.923.876 1.68.63C4.397 12.533 6.358 12 8 12s3.604.532 4.923.96c.757.245 1.477-.056 1.68-.631A7 7 0 0 0 8 3z" fillRule="evenodd"></path></svg>
				</div>
				<h5 className="mt-3">ContextHook</h5>
				 <button onClick={() => navigate("/contexthook")}>
						ContextData
					</button>
			</div>
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-pencil-square" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
					<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"></path>
					<path d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" fillRule="evenodd"></path></svg>
				</div>
				<h5 className="mt-3">100% Customizable</h5>
			</div>
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-phone-vibrate" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
				...
				<h5 className="mt-3">Mobile First</h5>
			</div>
			<div className="col-xl-3 col-lg-4 col-sm-6 text-center">
				<div className="text-muted">
					<svg className="bi bi-hand-thumbs-up" fill="currentColor" height="48" viewBox="0 0 16 16" width="48" xmlns="http://www.w3.org/2000/svg">
				...
				<h5 className="mt-3">No Catches</h5>
			</div>
		</div>
	</div>
</section>
